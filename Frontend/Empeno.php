...
<header class="heroCALEA">
    <div class="content container py-5">
        ...
        <div class="eyebrowN Juramedium">LEY QUE REGULA LAS CASAS DE EMPEÑO DEL ESTADO DE YUCATÁN.
            ARTICULO 27. OBLIGACIONES.
            FRACCIÓN VII:
        </div>

        <div class="eyebrowN Juramedium">
            Reportar a la Secretaría de Seguridad Pública todas las transacciones que realicen, con la periodicidad, medios y formatos que esta determine mediante lineamientos. La secretaría podrá implementar mecanismos electrónicos para recibir, en tiempo real, dicha información.
        </div>
    ...
    <section class="container">
        ...
        <div class="row g-3 g-md-4">
            <div class="col-6 col-md-4 col-lg-3">
                <a class="qa-card" href="<?php echo BASE_URL; ?>src/pdfs/CasasDeEmpeño.pdf"  target="_blank" rel="noopener">
                    <span class="qa-icon"><img src="src/images/estafa.png"  alt="Servicios Públicos" /></span>
                    <span class="Juramedium">Casa de Empeño que Reportan</span>
                </a>
            </div>
            <div class="col-6 col-md-4 col-lg-3">
                <a class="qa-card" href="http://187.157.145.178:8086/moduloempenos/"  target="_blank" rel="noopener">
                    <span class="qa-icon"><img src="src/images/casa-de-empeno.png"  alt="Servicios Públicos" /></span>
                    <span class="Juramedium">Módulos de Gestión de Empeño</span>
                </a>
            </div>
            <div class="col-6 col-md-4 col-lg-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card card-comunicate shadow-card-comunicate" >
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text Juramedium">
                                                        Teléfono de Oficina: (999) 9 30 32 00 ext: 49188
                                                    </p>
                                                    <p class="card-text Juramedium">
                                                        Número de Emergencia: 9-1-1
                                                    </p>
                                                    <p class="card-text Juramedium">
                                                        Correo electrónico: casasdeempeno.ssp@yucatan.gob.mx
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
